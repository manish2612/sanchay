...
export const AutoSuggestRoot = React.forwardRef<any, AutoSuggestRootProps>(({ children }, ref) => {
...
export const AutoSuggestInput = React.forwardRef<any, AutoSuggestInputProps>(
  (
    { placeholder = 'Search...', disabled, error, success, label, labelVariant, labelClassName },
    ref,
  ) => {
...
export const AutoSuggestGroup = ({
  children,
}: {
  children?: React.ReactNode;
  heading?: React.ReactNode;
}) => null;
export const AutoSuggestItem = ({ children }: { children?: React.ReactNode; value?: string }) =>
  null;
