...
import { useStandardRatesTable } from './useStandardRatesTable';
  ...
  return (
    <div className="space-y-4">
      <Form.Field
        ...
        name={STOCK_ITEM_FORM_FIELDS.ENABLE_STANDARD_RATES}
        render={({ field }) => (
          <Form.Item className="flex items-center gap-3 space-y-0 p-4 border border-border rounded-lg">
            ...
            <div className="space-y-1 leading-none">
              ...
              <p className="text-sm text-muted-fg">Enable advanced selling price configurations.</p>
            </div>
          </Form.Item>
        )}
      />
